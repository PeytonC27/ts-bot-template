...
module.exports = {
    data: (() => {
        ...
        for (let i = 1; i <= 10; i++) {
            cmd.addStringOption((option) => option.setName(`proficiency${i}`)
                .setDescription(`Proficiency ${i} that you want to add`)
                .setRequired(i === 1)
                .addChoices({ name: 'Strength', value: 'Strength' }, { name: 'Dexterity', value: 'Dexterity' }, { name: 'Constitution', value: 'Constitution' }, { name: 'Intelligence', value: 'Intelligence' }, { name: 'Wisdom', value: 'Wisdom' }, { name: 'Charisma', value: 'Charisma' }, { name: 'Acrobatics', value: 'Acrobatics' }, { name: 'Animal Handling', value: 'Animal Handling' }, { name: 'Arcana', value: 'Arcana' }, { name: 'Athletics', value: 'Athletics' }, { name: 'Deception', value: 'Deception' }, { name: 'History', value: 'History' }, { name: 'Insight', value: 'Insight' }, { name: 'Intimidation', value: 'Intimidation' }, { name: 'Investigation', value: 'Investigation' }, { name: 'Medicine', value: 'Medicine' }, { name: 'Nature', value: 'Nature' }, { name: 'Perception', value: 'Perception' }, { name: 'Performance', value: 'Performance' }, { name: 'Persuasion', value: 'Persuasion' }, { name: 'Religion', value: 'Religion' }, { name: 'Sleight of Hand', value: 'Sleight of Hand' }, { name: 'Stealth', value: 'Stealth' }, { name: 'Survival', value: 'Survival' }));
        }
        return cmd;
    })(),
